					...
					<div class="panel-body">
						<div class="row controls">
							<div class="col-md-12 button-list">
								<button class="btn btn-info" data-toggle="modal" data-target="#add-machine-modal">Add machines</button>
									...
									<tbody>
										@foreach( $machines as $machine )
											<tr>
											  	...
											  	<td><a class="btn btn-success" href="{{ route('machine', $machine->id) }}">Edit</a></td>
